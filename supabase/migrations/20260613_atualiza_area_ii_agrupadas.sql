-- ============================================================
-- Atualiza área II - DESCOBERTA ESPIRITUAL da classe Agrupadas
-- ============================================================

-- Remove registros antigos da área (cascade manual via membros_requisitos)
...
-- Insere novos requisitos atualizados
...
('7', 'II - DESCOBERTA ESPIRITUAL', 'Conversar sobre o que é cristianismo, as características de um verdadeiro discípulo e como ser um cristão verdadeiro.', '13 - 14 - ≥15', 19, true),
...
('7', 'II - DESCOBERTA ESPIRITUAL', 'Escolher um tema (parábola, milagre, sermão) e demonstrar conhecimento através de troca de ideias, atividade em grupo ou redação.', '11 - 12 - 13 - 14 - ≥15', 22, true),
...
ON CONFLICT (classe_id, ordem) DO NOTHING;
